...
def knn_cv(x, y):
    '''
    Cross validation using a KNN classifier (5 folds)
    '''
    ...
    for train_index, val_index in crss_val.split(x, y):
        ...
        clf = KNeighborsClassifier(n_neighbors=hyperparameters.get('n_neighbors'))
...
performances = knn_cv(x_train, y_train)
print(performances)
